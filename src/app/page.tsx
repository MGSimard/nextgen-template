...
const techStack = [
  ...
  ["next-themes", "-", "Themes", "https://github.com/pacocoursey/next-themes", "gh/pacocoursey/next-themes"],
  ["Sonner", "-", "UI Notifications", "https://sonner.emilkowal.ski/", "sonner.emilkowal.ski"],
];
