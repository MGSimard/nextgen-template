...
const techStack = [
  ...
  ["Drizzle", "0.41.0", "ORM", "https://orm.drizzle.team/docs/overview", "orm.drizzle.team"],
  ["Drizzle Kit", "0.30.6", "Database Migration", "https://orm.drizzle.team/docs/kit-overview", "orm.drizzle.team"],
  ["Better Auth", "1.2.5", "Authentication", "https://www.better-auth.com/docs/introduction", "better-auth.com"],
